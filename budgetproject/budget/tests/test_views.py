...
class TestViews(TestCase):
    ...
    def test_project_detail_DELETE_delete_an_existing_expense(self):
    ...
    def test_project_create_POST(self):
        ...
        # self.assertEquals(project2.category_set.first().name, 'design')
        # self.assertEquals(project2.category_set.all()[1].name, 'development')
